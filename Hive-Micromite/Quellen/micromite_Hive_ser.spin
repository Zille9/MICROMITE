...
PUB init
    ...
    ser.rxflush
    ser1.start(ios#SCL_pin,ios#SDA_pin,%0000,57600)
    ser1.rxflush
...
pub main|a,len,dpos,ss,sm,sh
   repeat  '' **** MAIN PROGRAM LOOP ****
        ...
        i2c := ser1.rxtime(2)'byte[register][1]
        if i2c<255
           ios.printdec(i2c)
           ios.printchar(32)
        ...
        case i2c
              ...
              ios#SWITCH_MODE:      SwitchMode(byte[register][2])
                                    ser1.rxflush'slave.put(1,0)                                             'clear the $1e register
              ...
              ios#CLEAR_REG:        ser1.rxflush'slave.flush                                                'clear all the i2c registers

'##################### DMP-Player ##############################
              ios#DMPL_PLAY:        ios.sid_sdmpplay(@filemanage)
                                    ser1.rxflush'slave.put(1,0)
                                    Play:=1
